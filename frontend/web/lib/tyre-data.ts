...
export interface Tyre {
  ...
  model: string   // Alias for pattern — used by TyreCard display
  size: string
  price: number
  image: string   // Used by TyreCard component
  imageUrl: string // Backend field alias
  features: string[]
...
export const tyreData: Tyre[] = [
  ...
  // Extra entries for pagination testing
  {
    id: "11",
    brand: "MRF",
    pattern: "ZVTV",
